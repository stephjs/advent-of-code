...
function howManyStepsPart2(dataIn, startIndex) {
	const startNumber = dataIn[startIndex];
	const numberOfSteps = dataIn[startIndex];
    const valueToGoTo = dataIn[startIndex + numberOfSteps];
    if (Math.abs(valueToGoTo) >= 3) {
    	dataIn[startIndex] = dataIn[startIndex] - 1;
    } else {
    	dataIn[startIndex] = dataIn[startIndex] + 1;
    }
